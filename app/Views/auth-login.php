                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card">
                            ...
                            <div class="card-body p-4"> 
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to <?=$company_name ?>.</p>
                                </div>
                                <div class="p-2 mt-4">
                                    ...
                                    <form action="<?= base_url('login') ?>" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control rounded-0" id="email" name="email" autofocus placeholder="jsmith@mail.com" required="required">
                                        </div>
                
                                        <div class="mb-3">
                                            <div class="float-end">
                                                <a href="<?= base_url('/recover-password') ?>" class="text-muted">Forgot password?</a>
                                            </div>
                        ...
                        <div class="mt-5 text-center">
                            <p>© <script>document.write(new Date().getFullYear())</script> <?=$company_name ?>.</p>
                        </div>
