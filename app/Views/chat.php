                                            ...
                                            <ul class="list-unstyled mb-0 chat-conversation-message px-3" data-simplebar>
                                                    ...
                                                    <div class="conversation-list">
                                                        <div class="ctext-wrap">
                                                            <div class="ctext-wrap-content">
                                                                <h5 class="font-size-14 conversation-name"><a href="#" class="text-reset ">John Howard</a> <span class="d-inline-block font-size-12 text-muted ms-2">10:00</span></h5>
                                                                <p class="mb-0">
                                                ...
                                                <li>
                                                    <div class="conversation-list">
                                                        <div class="ctext-wrap">
                                                            <div class="ctext-wrap-content">
                                                                <h5 class="font-size-14 conversation-name"><a href="#" class="text-reset ">Galen Rizo</a> <span class="d-inline-block font-size-12 text-muted ms-2">10:04</span></h5>
                                                                <p class="mb-0">
                                                                    Hello!
                                                                </p>
                                                            </div>
                                                ...
                                                <li>
                                                    <div class="conversation-list">
                                                        <div class="ctext-wrap">
                                                            <div class="ctext-wrap-content">
                                                                <h5 class="font-size-14 conversation-name"><a href="#" class="text-reset ">John Howard</a> <span class="d-inline-block font-size-12 text-muted ms-2">10:06</span></h5>
                                                                <p class="mb-0">
