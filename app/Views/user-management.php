...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table.on('click', 'tr:not(:first)', function(e) {
            ...
            var clickedColumnIndex = $(e.target).index();
            console.log("C", clickedColumnIndex);

            // Check if the clicked column is the "Login Link" column (column index 7)
            if (clickedColumnIndex === 6 ) {
                return; // Exit if "Login Link" column is clicked
            }
