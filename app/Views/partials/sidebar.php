...
<div class="vertical-menu">
    ...
    <div class="navbar-brand-box">
        <a href="index" class="logo logo-dark">
            <span class="logo-sm">
                <img src="assets/images/ttmg-logo-crm.png.png" alt="" height="120">
            </span>
            <span class="logo-lg">
                <img src="assets/images/ttmg-logo-crm.png.png" alt="" height="120">
            </span>
        ...
        <a href="index" class="logo logo-light">
            <span class="logo-sm">
                <img src="assets/images/ttmg-logo-crm.png" alt="" height="120">
            </span>
            <span class="logo-lg">
                <img src="assets/images/ttmg-logo-crm.png" alt="" height="120">
            </span>
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="file-manager" class=" waves-effect">
                        ...
                        <span><?= lang('Files.File Manager') ?></span>
                    </a>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="ui-utilities"><?= lang('Files.Utilities') ?><span class="badge rounded-pill bg-success float-end">New</span></a></li>
